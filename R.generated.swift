...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    #if os(iOS) || os(tvOS)
    struct addIngredient: Rswift.StoryboardResourceType, Rswift.Validatable {
      let addIngredientViewController = StoryboardViewControllerResource<AddIngredientViewController>(identifier: "AddIngredientViewController")
      let bundle = R.hostingBundle
      let name = "AddIngredient"

      func addIngredientViewController(_: Void = ()) -> AddIngredientViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: addIngredientViewController)
      }
